...
<div class="container mt-5 p-4 shadow rounded" style="background-color: #fff; border: 1px solid #eee;">
    ...
    <div class="row" id="postsContainer">
        ...
        <!-- Paste your post card HTML here -->
...
<div id="createPostModal" class="custom-modal-overlay" style="display: none;">
    <div class="custom-modal"
        style="background: #fff; padding: 20px; border-radius: 10px; max-width: 700px; margin: 5% auto; position: relative;">
        <span class="close-btn" onclick="document.getElementById('createPostModal').style.display='none'"
