        ...
        <div class="col-md-6">
            <div class="card shadow-lg" style="background-color: rgba(245, 245, 245, 1); border: none;">
                <div class="card-header text-center" style="background-color: transparent; border-bottom: none;">
                    <img src="<?= base_url('assets/images/blog.png') ?>" alt="Logo" class="img-fluid"
                    ...
                    <form action="<?= base_url('users/register') ?>" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control"
                                style="border: 1px solid rgba(190, 200, 200, 1); background-color: rgba(220, 230, 230, 0.4); padding: 0.50rem 1rem;"
                                required>
                        </div>
                        ...
                        <div class="d-grid">
                            <button type="submit"
                                style="background: rgb(240, 131, 6); color: white; padding: 0.50rem 1rem; font-size: 1.25rem; font-weight: bold; border: none; border-radius: 0.3rem;"
